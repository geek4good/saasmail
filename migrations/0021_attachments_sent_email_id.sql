...
INSERT INTO `attachments_new` (`id`, `email_id`, `filename`, `content_type`, `size`, `r2_key`, `created_at`, `content_id`)
	SELECT `id`, `email_id`, `filename`, `content_type`, `size`, `r2_key`, `created_at`, `content_id` FROM `attachments`;
